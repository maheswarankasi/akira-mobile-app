...
const resources = {
  en: {
    translation: {
      ...
      fresh_picks_subtitle:
        "Explore farm-fresh produce and everyday groceries.",
      tab_all: "All",
      ...
      cat_millets: "Millets",
      cat_flours: "Flours",
      cat_oil_ghee: "Oil & Ghee",
      cat_pickles: "Pickles & Thokku",
      cat_dals: "Dals & Pulses",
      cat_jaggery: "Jaggery & Karupatti",
      cat_snacks: "Organic Snacks",
      "profile_title": "My Profile",
  "my_orders": "My Orders",
  "manage_addresses": "Manage Addresses",
  "change_language": "Language / மொழி",
  ...
  ta: {
    translation: {
      ...
      fresh_picks_subtitle:
        "பண்ணை புதிய காய்கறிகள் மற்றும் மளிகைப் பொருட்களை ஆராயுங்கள்.",
      tab_all: "அனைத்தும்",
      tab_vegetables: "காய்கறிகள்",
      tab_fruits: "பழங்கள்",
      tab_millets: "சிறுதானியங்கள்",
      view_all: "அனைத்தையும் காண்க",
      all_categories_title: "அனைத்து வகைகள்",
      cat_vegetables: "காய்கறிகள்",
      cat_fruits: "பழங்கள்",
      cat_millets: "சிறுதானியங்கள்",
      cat_flours: "மாவு வகைகள்",
      cat_oil_ghee: "எண்ணெய் & நெய்",
      cat_pickles: "ஊறுகாய் & தொக்கு",
      cat_dals: "பருப்பு வகைகள்",
      cat_jaggery: "வெல்லம் & கருப்பட்டி",
      cat_snacks: "இயற்கை தின்பண்டங்கள்",
      "profile_title": "என் சுயவிவரம்",
  "my_orders": "எனது ஆர்டர்கள்",
  "manage_addresses": "முகவரிகளை நிர்வகிக்க",
